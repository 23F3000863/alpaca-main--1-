...
def autonomous_trading_loop():
    ...
    while True:
        try:
            ...
            # Monitor active positions and dynamically ratchet trailing stops as profit increases
            positions = portfolio_service.get_positions()
            if positions:
                protection_agent.monitor_and_trail_positions(
                    positions,
                    agent_orchestrator.current_regime,
